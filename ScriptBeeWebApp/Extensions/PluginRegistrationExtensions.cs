...
public static class PluginRegistrationExtensions
{
    ...
    private static IPluginRegistrationService RegisterPluginTypes()
    {
        ...
        pluginRegistrationService.Add(
            PluginKind.Loader,
            new HashSet<Type> { typeof(IModelLoader) }
        );
        pluginRegistrationService.Add(
            PluginKind.Linker,
            new HashSet<Type> { typeof(IModelLinker) }
        );
        pluginRegistrationService.Add(
        ...
        pluginRegistrationService.Add(
            PluginKind.ScriptRunner,
            new HashSet<Type> { typeof(IScriptRunner) }
        );
        pluginRegistrationService.Add(
            PluginKind.HelperFunctions,
