...
sh ./scripts/prepare_plugin_folder.sh "$version" "$plugins_folder/ScriptGeneration/DxWorks.ScriptBee.Plugin.ScriptGeneration.CSharp/DxWorks.ScriptBee.Plugin.ScriptGeneration.CSharp.csproj" "$output_path/DxWorks.ScriptBee.Plugin.ScriptGeneration.CSharp" && \
sh ./scripts/prepare_plugin_folder.sh "$version" "$plugins_folder/ScriptGeneration/DxWorks.ScriptBee.Plugin.ScriptGeneration.Javascript/DxWorks.ScriptBee.Plugin.ScriptGeneration.Javascript.csproj" "$output_path/DxWorks.ScriptBee.Plugin.ScriptGeneration.Javascript" && \
sh ./scripts/prepare_plugin_folder.sh "$version" "$plugins_folder/ScriptGeneration/DxWorks.ScriptBee.Plugin.ScriptGeneration.Python/DxWorks.ScriptBee.Plugin.ScriptGeneration.Python.csproj" "$output_path/DxWorks.ScriptBee.Plugin.ScriptGeneration.Python" && \
