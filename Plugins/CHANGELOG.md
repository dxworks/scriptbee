...
- update `@angular/forms` to 22.1.7
- update `@angular/platform-browser` to 22.1.7
- update `@angular/router` to 22.1.7
...
- added UI Plugin for Charts based ECharts
