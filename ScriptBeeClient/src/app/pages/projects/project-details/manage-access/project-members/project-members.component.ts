...
export class ProjectMembersComponent {
  ...
  constructor() {
    effect(() => {
      if (this.rolesResource.isLoading()) {
        this.addMemberForm.controls.role.disable();
      } else {
        this.addMemberForm.controls.role.enable();
      }
    });
  }
  ...
  onAddMember() {
    ...
    this.projectService.updateProjectMember(this.projectId(), memberId, role!.id, memberType).subscribe({
      next: () => {
  ...
  onRemoveMember(member: ProjectMember) {
    ...
    this.projectService.removeProjectMember(this.projectId(), member.memberId, member.memberType).subscribe({
      next: () => {
        this.membersResource.reload();
